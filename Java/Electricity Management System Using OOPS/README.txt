*****Electricity Management System using OOPS in Java*****
...
1. Creation of Customer's Account
2. Generation of unique meter number for every customer
3. Updating the Customers' Details
4. Displaying the Customer's Details
5. Calculation of the bill
6. Generation of the bill
7. Payment of the bill by customer

Steps for Implementation :
1. Download the source code.
2. Run the code in any IDE - Eclipse / NetBeans, etc.
